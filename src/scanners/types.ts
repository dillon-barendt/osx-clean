...
export interface ScanOptions {
  downloadsDaysOld: number;
    recentlyAccessedDays: number; // Items accessed more recently than this are ignored
  largeFileMinMB: number;
  largeFolderMinMB: number;
  duplicatesMinMB: number;
  minItemMB: number;
    whitelist: string[]; // Glob patterns or substrings to exclude
}
...
// osx-clean only reports it and hands you the command to run yourself.
